      ...
      <div className="mb-16">
        ...
        <div className="text-center">
          <h3 className="text-4xl sm:text-52 font-medium tracking-tighter text-black dark:text-white mb-3 leading-10 sm:leading-14">
            {locale === "ar"
              ? "هل لديك أسئلة؟ جاهز للمساعدة!"
              : "Have questions? ready to help!"}
          </h3>
          <p className="text-xm font-normal tracking-tight text-black/50 dark:text-white/50 leading-6">
            {locale === "ar"
              ? "هل تبحث عن منزل أحلامك أو مستعد للبيع؟ يقدم فريق الخبراء لدينا إرشادات شخصية وخبرة في السوق مصممة خصيصاً لك."
          ...
          <div className="relative w-fit">
            ...
            <div className="absolute top-6 left-6 lg:top-12 lg:left-12 flex flex-col gap-2">
              ...
              <p className="text-sm xs:text-base mobile:text-xm font-normal text-white/80">
                {locale === "ar"
                  ? "جاهز للعثور على منزلك المنامي أو بيع عقارك؟ نحن هنا للمساعدة!"
